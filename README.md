...
[![PyPI version](https://badge.fury.io/py/ultra-graph-basic.svg)](https://pypi.org/project/ultra-graph-basic/)
...
result = basic("Hello World")

# Example 2: Batch processing
from ultra_graph_basic import batch
